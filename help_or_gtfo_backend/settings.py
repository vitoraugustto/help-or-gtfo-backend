"""
Django settings for help_or_gtfo_backend project.
...
ALLOWED_HOSTS += ("localhost", "127.0.0.1") if ENV_MODE == "development" else None
...
WSGI_APPLICATION = "help_or_gtfo_backend.wsgi.application"


# Database
# https://docs.djangoproject.com/en/4.2/ref/settings/#databases0
